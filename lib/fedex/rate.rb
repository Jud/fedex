module Fedex
  ...
  class Rate
    ...
    attr_accessor :service_type, :transit_time, :delivery_timestamp, :rate_type, :rate_zone, :total_billing_weight, :total_freight_discounts, :total_net_charge, :total_taxes, :total_net_freight, :total_surcharges, :total_base_charge
